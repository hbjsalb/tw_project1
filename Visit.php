	...
	<div class="container">
		<div id="scheduleBox" class="schedule">
			<form id="scheduleFrm" action="" method="post" class="schedule-container">
				...
				<?php } ?>
				<span>Covict name :</span><span id="txtHint" style="margin-left:13%;color:black;font-family:inherit;font-size:1.3em;"></span><br>
				<span>Choose date:</span><input type="date" name="scheduleDate" required="required" min="<?php echo htmlspecialchars($nowFormat); ?>"><br>	
				<span>Convict id:</span><input name="id" type="number" required="required" onkeyup="showUser(this.value)"><br>
